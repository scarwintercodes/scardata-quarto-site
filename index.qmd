...
::: {#landing-icons}
[{{< fa brands linkedin title="linkedin" >}}](https://www.linkedin.com/in/scar-wk/){target="_blank"} &nbsp; [{{< fa brands github title="github" >}}](https://github.com/scarwintercodes){target="_blank"} &nbsp; [{{< fa brands bluesky title="bluesky" >}}](https://bsky.app/profile/scardata.bsky.social){target="_blank"} &nbsp; [{{< fa envelope title="envelope" >}}](mailto:scarwinterkelsey@gmail.com)
:::
:::